import skribble, { handleSkribbleError, Types, SkribbleAPIError } from '../../../sdks/typescript/src';
...
const USERNAME = process.env.SKRIBBLE_USERNAME as string;
const API_KEY = process.env.SKRIBBLE_API_KEY as string;
