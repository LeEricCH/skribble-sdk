...
<ParamField path="attachment_name" type="string" required>
  Name of the attachment
</ParamField>

<ParamField path="attachment_content_type" type="string" required>
  Content type of the attachment
</ParamField>

<ParamField path="attachment_base64_content" type="string" required>
