...
<CodeGroup>
```python Python
skribble.signature_request.withdraw(signature_request_id: str, message: str = None) -> None
```

```typescript TypeScript
skribble.signature_request.withdraw(signatureRequestId: string, message?: string): Promise<void>
```
</CodeGroup>
