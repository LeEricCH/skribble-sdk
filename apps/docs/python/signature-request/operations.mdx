...
attachment_response = skribble.signature_request.attachment.add(signature_request_id, attachment)
```
...
```python
attachment_content = skribble.signature_request.attachment.get(signature_request_id, attachment_id)
```
